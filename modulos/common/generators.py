#!/usr/bin/env python3
"""
Módulo especializado en la generación de datos y archivos de prueba (textos y binarios).
Centraliza los payloads y generadores estructurales para mantener el motor del lab limpio.
"""
...
def make_leeme_md() -> str:
    return """# Laboratorio de Malware Educativo

## Descripcion
Laboratorio educativo para simular el comportamiento de distintas
amenazas de seguridad informatica en un entorno controlado.
...
## Uso
1. Ejecutar `python core/lab_setup.py` para generar los archivos
2. Ejecutar un modulo desde `modulos/` o usar la TUI global
...
def make_mp3() -> bytes:
    ...
    ss = len(all_frames)
    syncsafe = bytes([(ss >> 21) & 0x7f, (ss >> 14) & 0x7f, (ss >> 7) & 0x7f, ss & 0x7f])
...
def make_docx() -> bytes:
    ...
    with zipfile.ZipFile(buf, 'w', zipfile.ZIP_DEFLATED) as z:
        ...
        z.writestr('word/document.xml', (
            ...
            '<w:p><w:r><w:t>Este archivo fue creado para el laboratorio.</w:t></w:r></w:p>'
            '</w:body></w:document>'))
...
def make_pptx() -> bytes:
    ...
    with zipfile.ZipFile(buf, 'w', zipfile.ZIP_DEFLATED) as z:
        ...
        z.writestr('ppt/slides/slide1.xml', (
            ...
            '<p:txBody><a:bodyPr/><a:p><a:r><a:rPr lang="es-AR" sz="4400"/><a:t>Malware Lab</a:t></a:r></a:p></p:txBody>'
            '</p:sp></p:spTree></p:cSld>'
            '</p:sld>'))
        z.writestr('ppt/_rels/presentation.xml.rels', (
            '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'
            '<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">'
            '<Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/slide" Target="slides/sheet1.xml"/>'
            '</Relationships>'))
    return buf.getvalue()