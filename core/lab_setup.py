#!/usr/bin/env python3
"""
Genera archivos de usuario para el laboratorio.
DRY: unico generador compartido por todos los modulos.

Uso:
    python core/lab_setup.py          Generar 12 archivos de prueba
    python core/lab_setup.py --clean  Eliminar todos los archivos generados
"""
import os
import sys
import struct
...
2. Ejecutar un modulo desde `modulos/` o usar `python -m core.cli`
...
def main():
    ...
    print(f"\nListo. {len(LAB_FILES)} archivos creados en:")
    print(f"  {DIR}")
